    ...
    <div style={{height: '5200px'}} className="Light-bg">
        ...
        <div class="scroll-page-3" id="page-3">
            <div id="section-headings" style={{color: 'rgb(34, 32, 32)'}}>
                ...
                <div id="education">
                    <div class="coa">
                        <img id="mmu-coa" alt="mmu coat of arms" src="https://upload.wikimedia.org/wikipedia/commons/c/ce/Greater_Manchester_County_Council_Arms.png"></img>
                        <img id="mmu-logo" alt="mmu logo" src="https://upload.wikimedia.org/wikipedia/en/thumb/9/94/Manchester_Metropolitan_University_logo.svg/1200px-Manchester_Metropolitan_University_logo.svg.png" />
                        <img id="mmu-coa" alt="mmu coat of arms" src="https://upload.wikimedia.org/wikipedia/commons/c/ce/Greater_Manchester_County_Council_Arms.png"></img>
                    </div>                    <h3>MSc Software Engineering</h3>
                    <i><p>Distinction</p></i>
        ...
        <div id="contact">
            ...
            <h3>
                <a aria-label="James Gabbitus Linkedin" href="https://www.linkedin.com/in/james-gabbitus/" title="Linkedin">
            ...
            <h3>
                <a aria-label="James Gabbitus Github" href="https://github.com/JamesGabby" title="Github">
